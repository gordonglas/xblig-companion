...
public class XBLIGCompanionActivity extends FragmentActivity {
	private static final String[] CONTENT = new String[] { "Catalog", "Picks" };
	
	HomeFragmentAdapter _adapter;
	ViewPager _pager;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        //HttpResponseCacheDataSource.getInstance(this).deleteAllCache();
        
        // hides the status bar and such.. good for games
        ...
        _adapter = new HomeFragmentAdapter(this);
        _adapter.addFragmentSpec(ScreenType.HOME, TabType.HOME_CATALOG, CatalogFragment.class, null);
        _adapter.addFragmentSpec(ScreenType.HOME, TabType.HOME_PICKS, PicksFragment.class, null);
    ...
    public void onResume() {
    	super.onResume();
    	AppScreens.onActivityResume(ScreenType.HOME);
    	_actionBar.onScreenChange(ScreenType.HOME, AppScreens.getCurrentTab(ScreenType.HOME));
    }
    
    class HomeFragmentAdapter extends FragmentPagerAdapter implements TitleProvider, ViewPager.OnPageChangeListener {
    	...
    	public Fragment getFragment(int position) {
    		//return XBLIGCompanionActivity.this.getSupportFragmentManager().findFragmentById(id);
		...
		@Override
		public int getCount() {
			return XBLIGCompanionActivity.CONTENT.length;
		}

		@Override
		public String getTitle(int position) {
			return XBLIGCompanionActivity.CONTENT[position % XBLIGCompanionActivity.CONTENT.length].toUpperCase();
		}
		...
		public void onPageSelected(int tabPosition) {
			AppScreens.setCurrentTab(ScreenType.HOME, tabPosition);
			_actionBar.onScreenChange(ScreenType.HOME, AppScreens.getCurrentTab(ScreenType.HOME));
		}
    }
}